...
if ($? -eq "true") {
    ...
    Send-MailMessage -SmtpServer smtp.office365.com -Port 587 -UseSsl -From $correu -To $correu -Subject 'Copia de seguretat finalitzada' -Body "La copia de seguretat s'ha realitzat correctament" -Credential $mycredentials 
